...
function Home() {
    return ( 
        <div className='container mx-auto flex flex-col items-center gap-10'>
                ...
                <div className="grid grid-cols-3 gap-40 items-center">
                    ...
                    <div className="col-span-2 font-medium ">
                        ...
                        <ul className="bg-gray-100 mt-2">
                            <li className="p-2 hover:bg-sky-500 hover:text-white">Sample</li>
                            <li className="p-2 hover:bg-sky-500 hover:text-white">Sample</li>
                            <li className="p-2 hover:bg-sky-500 hover:text-white">Sample</li>
                            <li className="p-2 hover:bg-sky-500 hover:text-white">Sample</li>
                        </ul>
            ...
            <button className="bg-sky-500 rounded-xl px-14 py-3 text-white font-bold active:bg-sky-600">Xác nhận</button>
